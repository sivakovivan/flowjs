 ...
 */
export function compatiblePrimitives(capability: CapabilityDescriptor): Primitive[] {
  switch (capability.kind) {
    ...
    case "state": {
      ...
      return inline ? ["dropdown", "segmented-control", "button-group"] : ["dropdown"];
    }
    case "action": {
...
export function isCompatible(capability: CapabilityDescriptor, primitive: Primitive): boolean {
